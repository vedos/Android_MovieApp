...
import com.example.vedad.moviesearch.fragments.TVShowsFragment.OnListFragmentInteractionListener;
import com.example.vedad.moviesearch.helper.Config;
import com.example.vedad.moviesearch.models.TVShow;

import java.util.List;

public class MyTVShowsRecyclerViewAdapter extends RecyclerView.Adapter<MyTVShowsRecyclerViewAdapter.ViewHolder> {

    private final List<TVShow> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyTVShowsRecyclerViewAdapter(List<TVShow> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder,final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myIntent.putExtra("title", mValues.get(position).name);
